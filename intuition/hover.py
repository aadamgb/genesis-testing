...
bambi.set_pos([0.0, 0.5, 2.0], zero_velocity=True)
bambi.set_quat([1.0, 0.0, 0.0, 0.0], zero_velocity=True)
...
for _ in range(steps ):
    ...
    a300.set_propellers_rpm((1 + 0 * 0.8) * 8120.65)
    # crazy_fly.set_propellers_rpm((1 + 0 * 0.8) * 14475.81)
    bambi.set_propellers_rpm((1 + 0 * 0.8) * 20475.81)
    scene.step()